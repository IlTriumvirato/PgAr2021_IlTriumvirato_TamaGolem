...
public class BattleHandler {
	...
	public static ArrayList<Elemento> getListaElementi(){
		...
		String[] stringheElementi= Constants.elements_names;
		//here it should take the list from the file. If the list is incorrect, it takes the default one
	...
	public static ArrayList<String> getElencoGemme(){
		...
		for(int i=0;i<primeGemme.size();i++) {
			elencoGemme.add(String.format(Constants.GEMMA_DI, primeGemme.get(i).getTipo().getNome()));
		}
		return elencoGemme;
	}
