...
public class MenuScreen extends MyMenu {
	...
	private void changeElements() {
		...
		System.out.println(Constants.CHANGE_ELEMENTS_MESSAGE);
		...
		Constants.elements_names=array;
		Constants.lista_totale_elementi=new ArrayList<Elemento>();
		
		Constants.lista_totale_elementi=BattleHandler.getListaElementi();
